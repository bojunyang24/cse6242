...
class LinearRegressionModel():
    ...
    def lgTrainAccuracy(self,y_train,y_predict_train):
        ...
        # -------------------------------
        # ADD CODE HERE
        mask = y_predict_train >= 0.5
        y_predict_train[mask] = 1
        y_predict_train[~mask] = 0
    ...
    def lgTestAccuracy(self,y_test,y_predict_test):
        ...
        # -------------------------------
        # ADD CODE HERE
        mask = y_predict_test >= 0.5
        y_predict_test[mask] = 1
        y_predict_test[~mask] = 0
...
# Q3.3.2 Hyper-parameter Tuning
    ...
    def hyperParameterTuning(self,rf_clf,x_train,y_train):
        ...
        # -------------------------------
        # ADD CODE HERE
        paramaters = {'n_estimators': [4, 16, 256], 'max_depth': [2, 8, 16]}
        gscv_rfc = GridSearchCV(rf_clf, paramaters)
